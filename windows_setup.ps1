...
choco install -y microsoft-windows-terminal vscode git mingw  # minGW-w64 is installed by mingw package
choco install -y gpu-z cpu-z choco hwmonitor # hardware monitoring software
